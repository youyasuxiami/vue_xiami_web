...
<script>
    import {getBlogTypes, getArticleByBlogType} from "@/api/classify";
    ...
    export default {
        ...
        methods: {
            clickTime(content) {
                ...
                params.append("blogTypeName", content);
                getArticleByBlogType(params).then(response => {
                    if (response.code == "20000") {
