...
<script>
    ...
    export default {
        ...
        created() {
            getUserInfo({blogId: this.blogId}).then(response => {
                if (response.code == "20000") {
                    this.webConfigData = response.data;
                    this.payCode = this.webConfigData.aliPay;
                }
            });
        },
        methods: {
            ...
            choosePay: function (type) {
                ...
                if (type == 1) {
                    ...
                    this.payCode = this.webConfigData.weixinPay;
                }
            },
            //博客点赞
            praiseBlog: function (uid) {
                ...
                praiseBlogById(params).then(response => {
