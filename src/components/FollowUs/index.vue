...
<!--        <li class="gitee" v-if="contact.gitee"><a :href="contact.gitee" target="_blank"><span>Gitee</span>{{contact.gitee}}</a></li>-->
        ...
        <li class="qqGroup" ><a href="//shang.qq.com/wpa/qunwpa?idkey=88bc57d77601a3c5ae97fe6d9c0bfa25c2ae166d8f0b9f6da6f7294097be6d08" target="_blank"><span>QQ群</span>123456789</a></li>
        <li class="qq" ><a href="tencent://AddContact/?fromId=50&fromSubId=1&subcmd=all&uin=1595833114" target="_blank"><span>QQ号</span>891627097</a></li>
        <li class="email" ><a :href="mailto" target="_blank"><span>邮箱帐号</span>891627097@qq.com</a></li>
        <li class="wxgzh" ><a href="/" target="_blank"><span>微信号</span>imys2150</a></li>
        <li class="github" ><a :href="contact.github" target="_blank"><span>Github</span>https://github.com/moxi624</a></li>
        <li class="gitee" ><a :href="contact.gitee" target="_blank"><span>Gitee</span>https://gitee.com/moxi159753</a></li>
      </ul>
    </div>
</template>
